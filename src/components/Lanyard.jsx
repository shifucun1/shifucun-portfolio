        ...
        <RigidBody position={[2, 0, 0]} ref={card} {...segmentProps} type={dragged ? 'kinematicPosition' : 'dynamic'}>
          ...
          >
            ...
            <mesh geometry={nodes.clip.geometry}>
              {metalColor ? (
                <meshPhysicalMaterial color={metalColor} roughness={0.38} metalness={0.82} clearcoat={0.4} />
              ) : (
            ...
            <mesh geometry={nodes.clamp.geometry}>
              {metalColor ? (
                <meshPhysicalMaterial color={metalColor} roughness={0.34} metalness={0.88} clearcoat={0.4} />
              ) : (
                <primitive object={materials.metal} attach="material" />
              )}
            </mesh>
